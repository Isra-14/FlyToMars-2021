...
/**=======================================================
//              Pantalla nivel 3                        ||
// EN ESTA CLASE SE CREAN LOS OBJETOS DEL NIVEL 3       ||
//======================================================||
// IN THIS CLASS ARE CREATED LEVEL 3 OBJECTS            ||
...
//    private Stage escenaMenuNiveles;
    ...
    private final int PUNTOS_SIGUIENTE_NIVEL = 8000;
...
//        crearBotonBack();
    ...
    private void crearFondo() {
        ...
        mapa = manager.get("mapas/nivel3.tmx");
 ...
 */
    ...
    private void moverAliensAgiles(float delta) {
        for (AlienAgil alienAgil : arrAliensAgiles) {
            ...
            if(alienAgil.getSprite().getY() < TAM_CELDA)
                alienAgil.caer();
    ...
    private void moverAliensLetales(float delta) {
        for (AlienLetal alienLetal : arrLetales) {
            ...
            if(alienLetal.getSprite().getY() < TAM_CELDA)
                alienLetal.caer();
    ...
    private void moverAliensTanques(float delta) {
        for (AlienTanque alienTanque : arrTanques) {
            ...
            if(alienTanque.getSprite().getY() < TAM_CELDA)
                alienTanque.caer();
